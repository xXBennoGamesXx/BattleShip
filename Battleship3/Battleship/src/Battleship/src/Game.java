...
public class Game extends BattleshipRunner{
    ...
    public void playBattleship1(Board b) {
        ...
        System.out.println("Pick your FIRST ship's size (number)");
        ...
        System.out.println("Pick your SECOND ship's size (number)");
        ...
        System.out.println("Pick your THIRD ship's size (number)");
        ...
        System.out.println("Pick a coordinate to attack; make sure x-coordinate is capitalized (Ex. \"A0,\"\"B6\")\" ");
        ...
        if (attackInput.length() != 2) {
            ...
            if (attackInput.length() != 2) {
                ...
                int x_coordAttack = (int) (attackInput.charAt(0));
                int newx_coordAttack = x_coordAttack - 65;
                int y_coordAttack = Integer.parseInt(attackInput.substring(1, 2));

            b.check(newx_cAttack,y_cAttack);
            b.takeTurn(newx_cAttack, y_cAttack);
